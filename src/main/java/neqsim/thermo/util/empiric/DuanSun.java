...
*/
	public double calcCO2solubimpurities(double temperature, double pressure, double salinity, double molefracvapCO2, double molefracvapN2, double molefracvapO2, double molefracvapH2O) {
		...
		//PZEROS
		        ...
		        {
		        OMEGA=Math.atan(2.0*r/Q); PHI=Math.atan(Math.pow((Math.tan(Math.abs(OMEGA)/2.0)),1.0/3.0));
		        if(OMEGA<0.0)
		        {
		        	PHI=-PHI;
		        }
...
//		      System.out.println(IERR);
		...
		//Calculate fugacity coefficient (FC) for all components and phases
		        ...
		        for (int i=0;i<4;i++) {
		        dlnfc[i]=(b[i]/bv)*(zv-1.0)-Math.log(zv-bv)-(av/(2.0*Math.sqrt(2.0)*bv))*(2.0*sumav[i]/av-b[i]/bv)*Math.log((zv+2.414*bv)/(zv-0.414*bv));
		        fcv[i]=Math.exp(dlnfc[i]);
		        }
...
//		System.out.println(fv[3]);
		...
		EPS1000=3.4279*Math.pow(10.0,2.0)*Math.exp((-5.0866*Math.pow(10.0,-3.0)*T+9.469*Math.pow(10.0,-7.0)*Math.pow(T,2.0)));
		...
		Vm[0]=41.84*(0.1*7.29+(100*0.92)/(2600+P)+2.07/(T-288.0)-1.23*Math.pow(10.0,4.0)/((2600+P)*(T-288.0))+1.6*BORN);
		Vm[1]=41.84*(0.1*7.0);
		Vm[2]=41.84*(0.1*5.7889+(100*6.3536)/(2600+P)+3.2528/(T-288.0)-3.0417*Math.pow(10.0,4.0)/((2600+P)*(T-288.0))+0.3943*BORN);
...
//		System.out.println(Math.exp(Poynteff[2]));
		...
		K[3]=(a1+a2*T+a3*Math.pow(T,2.0)+a4*Math.pow(T,3.0)+a5*Math.pow(T,4.0))*Math.exp((P-1.0)*(a6+a7*T)/(1000.0*R*T));
		K[0]=Math.pow(10.0,(ACO20+ACO21*T+ACO22/T+ACO23*Math.log10(T)+ACO24/(Math.pow(T,2.0))+ACO25*Math.pow(T,2.0)))*Math.exp(Poynteff[0]);
		K[1]=Math.pow(10.0,(AN20+AN21*T+AN22/T+AN23*Math.log10(T)+AN24/(Math.pow(T,2.0))+AN25*Math.pow(T,2.0)))*Math.exp(Poynteff[1]);
		K[2]=Math.pow(10.0,(AO20+AO21*T+AO22/T+AO23*Math.log10(T)+AO24/(Math.pow(T,2.0))+AO25*Math.pow(T,2.0)))*Math.exp(Poynteff[2]);
...
//		System.out.println(K[3]);
		...
		//double lamdaN2Na1=0.1402-595.0*((1.0/T)-(1.0/Tro))-4.025*Math.log(T/Tro)+0.01044*(T-Tro)-2.131*Math.pow(10.0,-6.0)*(Math.pow(T,2.0)-Math.pow(Tro,2.0))+49970.0*((1.0/Math.pow(T,2.0))-(1.0/Math.pow(Tro,2.0)));
